...
QBShared.VehicleModels = {
	...
	[GetHashKey("18performante")] = {
		["name"] = "Lamborghini Performante", --VehicleName
		["brand"] = "Lamborghini", --Brand
		["model"] = "18performante", --spawncode
		["price"] = 500, --Price
		["category"] = "coupes", --leaveit
		["hash"] = GetHashKey("18performante"),--spawncode
		["shop"] = "custom", --custom for custom vehicle shop
	}, ]]--
